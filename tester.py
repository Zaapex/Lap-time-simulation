...
for radius in range(1, 100, 4):
    imag_v_max = max_velocity_front_inner(a, b, m=mass, g=g, h=height_CG, w=w, alfa_cl=alpha_Cl, l=wheelbase,
                                          CoPy=CoPy, alfa_cd=alpha_Cd, CoPz=CoPz, r=radius, mu=coef_friction, K=KR)
    ...
    plt.scatter(radius, root, color="b")
    print(root, radius)
